...
if (themeSelector) {
    ...
    function selectChange(value){
        ...
        if (theme != 'default') {
            ...
            require(['/static/x-admin/tubiao/example/theme/' + theme], function(tarTheme){
                curTheme = tarTheme;
...
if (developMode) {
    ...
    require.config({
        paths: {
            echarts: '/static/x-admin/tubiao/example/www/js'
        }
    });
    launchExample();
}
...
function launchExample() {
    ...
    require(
        [
            'echarts',
            '/static/x-admin/tubiao/example/theme/' + hash.replace('-en', ''), 
            'echarts/chart/bar',
            'echarts/chart/radar',
